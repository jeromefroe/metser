...
func (p *ThriftCounter) GetID() []int8 {
  return p.ID
}
...
func (p *ThriftCounter) writeField1(oprot thrift.TProtocol) (err error) {
  ...
  if err := oprot.WriteListBegin(thrift.BYTE, len(p.ID)); err != nil {
...
func (p *ThriftBatchTimer) GetID() []int8 {
  return p.ID
}
...
func (p *ThriftMetricUnion) GetID() []int8 {
  return p.ID
}
...
var _elem5 float64
    ...
    p.BatchTimerVal = append(p.BatchTimerVal, _elem5)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *ThriftMetricUnion) writeField2(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("ID", thrift.LIST, 2); err != nil {
